...
let
  immichHost =
    "immich.${cfg.server.host}"; # TODO: put your immich domain name here

  immichRoot =
    "${cfg.home_path}/.immich"; # TODO: Tweak these to your desired storage locations
  ...
  postgresPassword =
    "passwordrandomtuconnais"; # TODO: put a random password here
  postgresUser = "immich";
  postgresDb = "immich";
...
in {
  ...
  virtualisation.oci-containers.containers.immich_machine_learning = {
    ...
    environment = { IMMICH_VERSION = immichVersion; };
    volumes = [ "${immichAppdataRoot}/model-cache:/cache" ];
  };

  virtualisation.oci-containers.containers.immich_redis = {
    image =
      "redis:6.2-alpine@sha256:80cc8518800438c684a53ed829c621c94afd1087aaeb59b0d4343ed3e7bcf6c5";
  };
